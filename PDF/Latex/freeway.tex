...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{freeway.png}
...
\begin{figure}[h]
	\center
	\includegraphics[width=0.4\textwidth]{boxplot_vi.png}
...
\begin{figure}[h]
	\center
	\includegraphics[width=0.4\textwidth]{densidade_vi.png}
...
\begin{figure}[h]
	\center
	\includegraphics[width=0.4\textwidth]{densidade_pi.png}
